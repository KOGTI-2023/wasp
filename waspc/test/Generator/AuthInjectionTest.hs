...
spec_GeneratorAuthInjectionTest = do
  ...
  where
    ...
    makeAuthEntity userEntityIdFieldType maybeUserEntityIdFieldNativeDbType =
      let userIdField = makeAuthUserIdField userEntityIdFieldType maybeUserEntityIdFieldNativeDbType
       in ( "Auth",
            AS.Entity.makeEntity
              ( Psl.Model.Body
                  [ Psl.Model.ElementField $
    ...
    makeAuthUserIdField :: Psl.Model.FieldType -> Maybe Psl.Attribute.Attribute -> Psl.Model.Element
    makeAuthUserIdField userEntityIdFieldType maybeUserEntityIdFieldNativeDbType =
    ...
    -- Some other entity that is not related to the user entity
    someOtherEntity =
      ( "SomeOtherEntity",
        AS.Entity.makeEntity
          ( Psl.Model.Body
